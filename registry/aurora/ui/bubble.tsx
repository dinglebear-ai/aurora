...
const bubbleVariants = cva(
  "aurora-bubble group/bubble relative flex w-fit max-w-[36ch] min-w-0 flex-col gap-1 group-data-[align=end]/message:self-end data-[align=end]:self-end data-[variant=ghost]:max-w-full",
  {
    variants: {
      variant: {
